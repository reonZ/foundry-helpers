...
declare global {
    namespace dailies {
        ...
        interface Api {
            ...
            createRetrainBtn: (actor: ActorPF2e, selectedId: string, type: "vessel" | "tactic") => HTMLElement;
            dailyHelpers: {
            ...
            retrainFromElement: (actor: ActorPF2e, target: HTMLElement) => Promise<ChatMessagePF2e | undefined>;
