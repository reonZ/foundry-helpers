import { AbilityItemPF2e, FeatPF2e, MeleePF2e, WeaponPF2e } from "@7h3laughingman/pf2e-types";
import { DocumentUUID, ImageFilePath, ItemUUID } from "../../_types";
import { CreaturePF2e } from "@7h3laughingman/pf2e-types";
    ...
    namespace hud {
        ...
        interface Api {
            ...
            utils: {
                ...
                toggleStance: (actor: CreaturePF2e, sourceUUID: DocumentUUID, force?: boolean) => Promise<void>;
            };
        }
    }
}
