...
export declare function createToggleableWrapper(type: libWrapper.RegisterType, path: string | string[], callback: libWrapper.RegisterCallback, options?: WrapperOptions): Wrapper;
export declare function createCreatureSheetWrapper(type: libWrapper.RegisterType, partialPath: string | string[], callback: libWrapper.RegisterCallback, options?: WrapperOptions): Wrapper;
type Wrapper = {
    get enabled(): boolean;
    activate(): void;
    disable(): void;
